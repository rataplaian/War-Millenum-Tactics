...
export type Characteristic = 'MOVE' | 'BS' | 'WS' | 'SAVE' | 'LEADERSHIP' | 'OC' | 'HIT_ROLL' | 'WOUND_ROLL';
...
export interface Effect { id: string; source: string; target: { unitId: string }; payload: EffectPayload; createdAt: FlowStamp; expiry: Expiry; expiryPlayerId: string; stacking: Stacking; active: boolean }
