...
export type Trigger = 'START_OF_PHASE' | 'END_OF_PHASE' | 'START_OF_TURN' | 'END_OF_TURN' |
  'AT_START_OF_COMMAND_PHASE' | 'AT_END_OF_COMMAND_PHASE' | 'AFTER_TARGET_SELECTED' | 'AFTER_HIT_ROLL' |
...
export type FlowEventName = 'MORTAL_WOUNDS_RESOLVED' | 'AFTER_HIT_ROLL' | 'AFTER_WOUND_ROLL' | 'DEADLY_DEMISE_ROLLED' | 'SUPER_HEAVY_WALKER_TEST' | 'UNIT_EMBARKED' | 'DISEMBARK_CANCELLED' | 'DISEMBARK_STARTED' | 'DISEMBARK_COMPLETED' | 'COMBAT_DISEMBARK' | 'EMERGENCY_DISEMBARK_STARTED' | 'EMERGENCY_DISEMBARK_COMPLETED' | 'TRANSPORT_PASSENGER_DESTROYED' | 'FIRING_DECK_SELECTED' | 'ATTACHED_UNIT_FORMED' | 'ATTACHED_COMPONENT_DESTROYED' | 'ATTACHED_UNIT_SPLIT' | 'LEADER_SEPARATED' | 'SUPPORT_SEPARATED' | 'HAZARD_ROLLED' | 'TRANSPORT_DESTROYED' | 'ADVANCE_ROLLED' | 'BATTLE_ROUND_STARTED' | 'BATTLE_ROUND_ENDED' | 'TURN_STARTED' | 'TURN_ENDED' |
  ...
  'STRATAGEM_USED' | 'TEMPORARY_EFFECT_APPLIED' | 'TEMPORARY_EFFECT_EXPIRED' | 'COMMAND_ABILITY_RESOLVED' | 'MANDATORY_RESOLUTION_COMPLETED';
