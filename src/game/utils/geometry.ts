import type { BaseGeometry, BattlefieldDimensions, Position } from '../models';
...
export function positionInsideBattlefield(p: Position, field: BattlefieldDimensions): boolean {
...
export function baseInsideBattlefield(model: CircularFootprint, field: BattlefieldDimensions): boolean {
